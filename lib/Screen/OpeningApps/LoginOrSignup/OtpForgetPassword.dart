...
class OtpForgetPassword extends StatefulWidget {
  ...
  OtpForgetPassword(this.code, this.mobile);

  @override
  _OtpForgetPasswordState createState() => _OtpForgetPasswordState(code, mobile);
}

class _OtpForgetPasswordState extends State<OtpForgetPassword> with TickerProviderStateMixin {
  ...
  _OtpForgetPasswordState(this.userOtp, this.mobile);
                                                        ...
                                                        if (userOtp == code) {
                                                          ...
                                                          Navigator.of(context).pushReplacement(
                                                              MaterialPageRoute(
                                                                  ...
                                                                  new RestPasswordScreen(phoneNumber)));
