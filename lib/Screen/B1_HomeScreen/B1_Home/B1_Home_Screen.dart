...
import 'package:baskitian/Library/countdown_timer/countDownTimer.dart';
import 'package:baskitian/Model/HomeGridItemRecomended.dart';
import 'package:baskitian/Screen/B1_HomeScreen/HomeUIComponent/AppBar_Component/AppbarGradient.dart';
import 'package:baskitian/Screen/B1_HomeScreen/HomeUIComponent/Detai_Productl_Screen/CategoryDetail.dart';
import 'package:baskitian/Screen/B1_HomeScreen/HomeUIComponent/Detai_Productl_Screen/DetailProduct.dart';
import 'package:baskitian/Screen/B1_HomeScreen/HomeUIComponent/Detai_Productl_Screen/MenuDetail.dart';
import 'package:baskitian/Screen/B1_HomeScreen/HomeUIComponent/Detai_Productl_Screen/PromotionDetail.dart';
import 'package:baskitian/Screen/B1_HomeScreen/HomeUIComponent/Flash_Sale/FlashSale.dart';
...
class _MenuState extends State<Menu> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    ///  Grid2 item in bottom of Category
    var Grid2 = SingleChildScrollView(
      child: Container(
        color: Colors.white,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Padding(
              ...
              const EdgeInsets.only(left: 20.0, top: 20.0, right: 20.0),
              child: Text(
                AppLocalizations.of(context).tr("food"),
                style: TextStyle(
                  fontWeight: FontWeight.w700,
                  fontSize: 17.0,
                ),
    ...
    ///  Grid item in bottom of Category
    var Grid3 = SingleChildScrollView(
      child: Container(
        color: Colors.white,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Padding(
              ...
              const EdgeInsets.only(left: 20.0, top: 20.0, right: 20.0),
              child: Text(
                AppLocalizations.of(context).tr("handphone"),
                style: TextStyle(
                  fontWeight: FontWeight.w700,
                  fontSize: 17.0,
                ),
    ...
    ///  Grid2 item in bottom of Category
    var Grid4 = SingleChildScrollView(
      child: Container(
        color: Colors.white,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Padding(
              ...
              const EdgeInsets.only(left: 20.0, top: 20.0, right: 20.0),
              child: Text(
                AppLocalizations.of(context).tr("fashion"),
                style: TextStyle(
                  fontWeight: FontWeight.w700,
                  fontSize: 17.0,
                ),
